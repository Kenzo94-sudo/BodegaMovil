...
class SnacksFragment : Fragment(R.layout.fragment_snacks) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = ProductoAdapter(productoRepository.listarPorCategoria("Snacks"))
        recyclerProductos.adapter = adapter

        etBuscar.addTextChangedListener { texto ->
            val filtrados = productoRepository.buscarPorNombre(texto.toString(), "Snacks")
        ...
        parentFragmentManager.setFragmentResultListener(
            ...
            adapter.actualizar(
                productoRepository.buscarPorNombre(filtroActual, "Snacks")
            )
        }
